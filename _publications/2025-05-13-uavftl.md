...
bibtex: |
  @InProceedings{Nadkarni_2025_NCC,
      author    = {Nadkarni, Vedang Bhupesh Shenvi and Joshi, Sandeep and Lakshmi, L. Rajya},
      title     = {An Efficient Federated Transfer Learning Approach for Multi-UAV Systems},
      booktitle = {Proceedings of the 2025 National Conference on Communications (NCC)},
      year      = {2025},
      pages     = {1--6},
      doi       = {10.1109/NCC63735.2025.10983600}
  }
---

<sub>[Paper](#paper) [Citation](#rec-citation) <a href="#" class="copy-bibtex" title="Copy BibTeX">Copy BibTeX</a><textarea class="bibtex-content" style="display:none">{{ page.bibtex }}</textarea><span class="copy-msg" style="margin-left:8px;display:none;font:inherit;">Copied</span></sub>
