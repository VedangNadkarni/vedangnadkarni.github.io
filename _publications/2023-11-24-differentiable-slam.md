...
<sub>[Poster](#poster) [Paper](#paper) [Citation](#rec-citation) <a href="#" class="copy-bibtex" title="Copy BibTeX">Copy BibTeX</a><textarea class="bibtex-content" style="display:none">{{ page.bibtex }}</textarea><span class="copy-msg" style="margin-left:8px;display:none;font:inherit;">Copied</span></sub>
...
[Arxiv preprint](https://arxiv.org/abs/2309.09206)