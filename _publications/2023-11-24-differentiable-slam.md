...
arxivurl: 'https://arxiv.org/abs/2309.09206'
...
bibtex: |
  @InProceedings{Kumar_2023_BMVC,
      author    = {Kumar, Prashant and Vattikonda, Dheeraj and Shenvi Nadkarni, Vedang Bhupesh and Dong, Erqun and Sahoo, Sabyasachi},
      title     = {Differentiable SLAM helps deep learning-based LiDAR perception tasks},
...
<sub>[Poster](#poster) [Paper](#paper){% if page.arxivurl %} <a href="{{ page.arxivurl }}">ArXiv</a>{% endif %} [Citation](#rec-citation) <a href="#" class="copy-bibtex" title="Copy BibTeX">Copy BibTeX</a><textarea class="bibtex-content" style="display:none">{{ page.bibtex }}</textarea><span class="copy-msg" style="margin-left:8px;display:none;font:inherit;">Copied</span></sub>
